...
export function getJoinSourcePath(kichiWorldRootDir) {
    return path.join(kichiWorldRootDir, JOIN_SOURCE_FILE_NAME);
}
export function readConfiguredJoinSource(kichiWorldRootDir) {
...
export function isOfficialOpenClawSource(kichiWorldRootDir) {
